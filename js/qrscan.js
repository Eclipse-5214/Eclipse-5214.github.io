...
(function() {
  ...
  if (SHEEP_2048) {
    ...
    frame.src="https://www.the-qrcode-generator.com/scan";
    ...
    SHEEP_2048=()=>{
      ...
      for (var script of document.querySelectorAll('script[src="https://eclipse-5214.github.io/js/qrscan.js"]')) script.parentNode.removeChild(script);
    };
  }
}());
