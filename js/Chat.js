...
(function() {
  ...
  if (SHEEP_2048) {
    ...
    frame.src="https://eclipse-5214.github.io/Chat";
    frame.width=300; // additional 30px to hide scrollbars
    frame.height=600;
    frame.scrolling="no";
    applyStyles(frame,{
      position:'absolute',
    ...
    SHEEP_2048=()=>{
      ...
      for (var script of document.querySelectorAll('script[src="https://eclipse-5214.github.io/js/Chat.js"]')) script.parentNode.removeChild(script);
    };
  }
}());
